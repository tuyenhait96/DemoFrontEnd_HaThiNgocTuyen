...
module MonkeyRun{
    export enum Zom1States {IDLE, RUNNING, SHOTGUN_DEATH,
    ...
    export class Zom1 {
        ...
        update(currentLevel:Level, killerCollection:KillerCollection, Zom1List:Array<Zom1>,monkey:Monkey,
        ...
        Zom1MonkeyCollision(monkey:Monkey, killerCollection:KillerCollection){
            if(IS_CHEATING == true)
                return;
            this.game.physics.arcade.overlap(this.states, monkey.states, ()=>{
                ...
                else if (this.currentState !==Zom1States.THROWN_BY_GMO){
                    this.thrownByGMO();
        ...
        deathByItem(key,difficulty:Difficulty){
            ...
            if(key === "grenade"){
                this.states.animations.currentAnim.onComplete.add(()=>{
                    this.states.alpha = 0;
                    this.currentState = Zom1States.GRENADE_DEATH;
        ...
        Zom1ItemCollision(thrownItems:Array<Phaser.Sprite>, killerCollection:KillerCollection, pickUpItems:Array<Phaser.Sprite>, difficulty:Difficulty){
        ...
        removeZom1FromGame(killerCollection:KillerCollection, Zom1List:Array<Zom1>){
