...
module MonkeyRun{
    export class Chest{
        ...
        update(monkey:Monkey, grenadeButton:ItemButton, shotgunButton:ItemButton, gmoButton:ItemButton, chestItems:Array<Chest>){
            this.game.physics.arcade.overlap(this.chest,monkey.states,()=>{
