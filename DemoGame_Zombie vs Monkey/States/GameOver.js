...
(function (MonkeyRun) {
    var GameOver = /** @class */ (function (_super) {
        ...
        GameOver.prototype.create = function () {
            ...
            //-------------- Sound
            this.inGameSound = this.game.add.sound("inGameSound");
            this.menuSound = this.game.add.sound("menuSound");
            this.playButton = this.game.add.button(this.game.width * 0.76, this.game.height * 0.01, "PlayButton", this.startGame, this);
            ...
            killsText.strokeThickness = 3;
            killsText.stroke = '#ffffff';
            ...
            gameOverText.strokeThickness = 3;
            ...
            this.sound.stopAll();
            this.gameOver = this.game.add.sound("gameOver");
            this.changeableValue = 1;
            this.gameOver.play();
            this.gameOver._sound.playbackRate.value = this.changeableValue;
